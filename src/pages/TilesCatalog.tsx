          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {filteredCatalogs.map((catalog, i) => (
              ...
              >
                ...
                {/* Info */}
                <div className="p-4">
                  <h3 className="font-heading font-bold text-gray-900 mb-1 line-clamp-2">
                    {catalog.title}
                  </h3>
                  <p className="text-gray-500 text-xs mb-2 line-clamp-2">{catalog.description}</p>
                  ...
                  <div className="flex items-center gap-3 text-xs text-gray-400 mb-4">
                    {catalog.pageCount && <span>📖 {catalog.pageCount} pages</span>}
                    <span>👁 {catalog.viewCount} views</span>
                    <span>📥 {catalog.downloadCount} downloads</span>
                  </div>
                  ...
                  <div className="flex gap-2">
                    {catalog.pdfUrl ? (
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 bg-primary hover:bg-blue-900 text-white text-xs font-semibold py-2.5 rounded-lg transition-colors cursor-pointer text-center"
                      >
                        👁 View PDF
                      </a>
                    ) : (
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 bg-gray-100 hover:bg-gray-200 text-gray-600 text-xs font-semibold py-2.5 rounded-lg transition-colors"
                      >
                        📋 Request Catalog
                      </button>
                    )}
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 flex items-center justify-center gap-1.5 text-white text-xs font-semibold py-2.5 rounded-lg transition-colors"
